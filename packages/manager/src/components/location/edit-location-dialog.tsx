...
export function EditLocationDialog({ id, open, onOpenChange }: EditLocationDialogProps) {
  ...
  if (open && formData.id === 0 && id != null) {
    const currentLocation = data[id]
    setFormData({
      id: currentLocation.id,
      name: currentLocation.name,
      mainImageName: currentLocation.mainImageName,
      individualImageName: currentLocation.individualImageName,
      backgroundImagePath: currentLocation.backgroundImagePath,
      color: currentLocation.color,
      address: currentLocation.address,
      startTime: currentLocation.startTime,
      endTime: currentLocation.endTime,
  ...
  const handleSubmit = useCallback(
    async (e: React.FormEvent) => {
      ...
      if (!hasError) {
        setIsLoading(true)
        try {
          const location = await updateLocation(token || '', {
            id: formData.id,
      ...
      <DialogContent>
        ...
        <div className="no-scrollbar -mx-4 max-h-[75vh] overflow-y-auto px-4">
          <form onSubmit={() => false}>
            ...
            <div className="mb-4">
              <Field>
                <FieldLabel>Name on the Individual Event Image</FieldLabel>
            ...
            <div className="mb-4">
              <Field>
                <FieldLabel>Path to the background image</FieldLabel>
                <Input
            ...
            <div className="mb-4">
              <Field>
                <FieldLabel>Color for the individual event image header</FieldLabel>
                <Input
                  id="color"
                  name="color"
                  type="text"
            ...
            <div className="mb-4">
              <Field>
                <FieldLabel>Normal start time for the events at this location</FieldLabel>
                <Input
                  id="startTime"
                  name="startTime"
                  type="text"
            ...
            <div className="mb-4">
              <Field>
                <FieldLabel>Normal end time for the events at this location</FieldLabel>
                <Input
                  id="endTime"
                  name="endTime"
                  type="text"
